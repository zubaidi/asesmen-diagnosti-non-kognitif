        ...
        <div class="page">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Tracer Study</li>
                </ol>
            </nav>
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Tracer Study</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('option') is-invalid @enderror" id="option" name="option" required>
                                        ...
                                        <option value="BEKERJA" {{ old('option') == 'BEKERJA' ? 'selected' : '' }}>BEKERJA</option>
                                        <option value="KULIAH" {{ old('option') == 'KULIAH' ? 'selected' : '' }}>KULIAH</option>
                                        <option value="WIRAUSAHA" {{ old('option') == 'WIRAUSAHA' ? 'selected' : '' }}>WIRAUSAHA</option>
                                    </select>
                                    @error('option')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
