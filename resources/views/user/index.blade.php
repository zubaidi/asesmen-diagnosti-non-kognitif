...
<body>
                ...
                <div class="hero-content">
                    <div class="hero-text">
                        ...
                        <a class="btn btn-primary mt-2" href="#" data-bs-toggle="modal"
                            data-bs-target="#mulaiKuisModal">Mulai Kuisioner</a>
                    </div>
                    <div class="hero-logo">
    ...
    <!-- Modal: Mulai Kuis -->
    <div class="modal fade" id="mulaiKuisModal" tabindex="-1" aria-labelledby="mulaiKuisModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">

                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="mulaiKuisModalLabel">
                        <i class="bi bi-pencil-square me-2"></i> Formulir Pendaftaran Kuis
                    </h5>
                ...
                <div class="modal-body">
                    <form id="quizForm">
                        ...
                        <h5 class="mb-3">Pilih Kategori Kuis</h5>
                        <div class="row g-4 mb-4">
                            <!-- Kategori A -->
                            <div class="col-md-4">
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title">Kategori A</h5>
                                        <p class="card-text">Aspek Kepribadian</p>
                                        <button type="button" class="btn btn-primary mt-auto"
                                            onclick="selectKategori('A')">
                                            Pilih Kategori A
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title">Kategori B</h5>
                                        <p class="card-text">Aspek Sosial</p>
                                        <button type="button" class="btn btn-success mt-auto"
                                            onclick="selectKategori('B')">
                                            Pilih Kategori B
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title">Kategori C</h5>
                                        <p class="card-text">Aspek Keterampilan</p>
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <strong>Informasi:</strong> Pastikan data yang Anda masukkan sudah benar sebelum memulai kuis.
                        Anda tidak dapat mengubah data setelah kuis dimulai
                    </div>
                </div>
            </div>
        </div>
